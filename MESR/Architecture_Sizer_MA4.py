...
def ARCH_Sizer_MA3(mpL, dvL, dvT, LUT, TUT):
    ...
    mp_surface = mpL
    mprop_cycle = int(Lander.mprop + TV.m_prop*2)
...
MA3 = ARCH_Sizer_MA3(mpL, dvL, dvT, LUT, TUT)
